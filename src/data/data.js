export const data = [
  {
    ...
    img: 'finpal',
    link: 'https://finpal.netlify.app/',
  },
  {
    name: 'Spotify clone',
    description:
      "Different to previous Spotify clone. This one does not use Spotify's API to validate an account so you may create one. It has a music player and since it does not work with Spotify's API, You can even reproduce music (Rock playlist is recomended 🤘). I tried to simulate the actual Spotify app's UI, but I also chose to change few interface elements. It is not completely functional, e.g. Search bar is just ornamentary, as playlist links on the sidebar. To be entirely honest you can find few bugs on the audio player, but none to disprove the hard work on this free-of-ads music player (more info on App Info button on sidebar). Responsive design.",
    img: 'spotify',
    link: 'https://spotify-clone-8a46d.web.app/',
  },
  {
    name: 'Amazon clone',
    description:
      "This is a very similar UI to Amazon's app. The functionalities are to create an account, add items to basket, proceed to checkout and finally to online-payment screen. Payments are treated with Stripe, you can even pay for the items not with an actual card (of course) but just fill the Card Number, CVC, month/year and Postal Code with 4242424242...... to the end and 'payment' will be done (there's no shipping though 😂), now there's a 'Orders' tab to see what you purchased. Not responsive",
    img: 'amazon',
    link: 'https://clone-e2ff6.web.app/',
  },
  {
    ...
    img: 'spotifyfirst',
    link: 'https://spotify-clone-5040e.web.app/',
  },
  {
    ...
    img: 'miniprojects',
    link: 'https://github.com/KurtGuardia/over-20-mini-React-projects',
  },
];
